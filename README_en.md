...
> **Demystifying the black box of Deep Learning and Core Algorithms with a pragmatic "Engineering Mindset".**

## 📖 About This Repository

This repository documents my hardcore journey transitioning from traditional backend development (Golang/Node.js) into the world of AI and core algorithms. 
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [Neural Network From Scratch (MNIST)](./01_nn_from_scratch_mnist) | MNIST, NumPy Backprop, PyTorch Benchmark | 🟢 Done | [Coming Soon]() |
...
---
> 💡 **Note on Code Comments:** > The source code comments are currently in Chinese to support the primary video tutorials. However, the code logic is highly self-explanatory, and the core math derivations are fully translated in the docs.
